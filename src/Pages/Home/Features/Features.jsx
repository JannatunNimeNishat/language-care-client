...
const Features = () => {
    return (
        <>
            <Reveal>
                <div className=" bg-[#f7f0ea]  min-h-screen py-10">
                    ...
                    <div className="my-container lg:flex gap-3 py-32 px-3 lg:px-0">
                        <div className='lg:w-1/2'>
                                ...
                                <div>
                                    ...
                                    <h3 className="text-3xl lg:text-4xl font-bold mt-1">Our Core Features</h3>
                                </div>


                            <div className='mt-12 grid grid-cols-1 text-center lg:text-left lg:grid-cols-2 gap-3 space-y-3'>
                                {/* 1st */}
                                <div className='w-4/5'>
                        ...
                        <div className='lg:w-1/2 mt-5 lg:mt-0 '>
                            <img className=' h-full rounded-tl-full ' src={featuresImg} alt="" />
                        </div>
                    </div>
                </div >
            </Reveal>
